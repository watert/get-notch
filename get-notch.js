...
export function supportsEnvNotch() {
  return CSS.supports && CSS.supports('padding-bottom: env(safe-area-inset-bottom)');
}
export function supportsConstantNotch() {
  return CSS.supports && CSS.supports('padding-bottom: constant(safe-area-inset-bottom)');
}
